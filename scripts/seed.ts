...
async function main() {
  ...
  await prisma.sponsor.upsert({
    ...
    create: {
      ...
      order: 1,
      isPublished: true,
      logoUrl: "/brand/partners/startidea.png",
      websiteUrl: "https://startidea.es",
      description: "Agencia creativa de Granada · diseño, desarrollo, IA aplicada.",
    },
    update: {
      logoUrl: "/brand/partners/startidea.png",
      websiteUrl: "https://startidea.es",
  ...
  await prisma.sponsor.upsert({
    ...
    create: {
      ...
      order: 2,
      isPublished: true,
      logoUrl: "/brand/partners/granadasocial-vertical.svg",
