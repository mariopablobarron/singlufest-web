...
const SEALS = [
  {
    ...
    body: "Todos los obradores trabajan en líneas exclusivas sin gluten. Cero cocinas compartidas.",
  },
  {
    Icon: FileSearch,
    title: "Auditoría externa",
    body: "Análisis ELISA aleatorios durante el evento. Si un plato falla, sale del cartel en directo.",
  },
  {
    Icon: GraduationCap,
  ...
  },
  {
    ...
    body: "Partners verificados por la asociación europea de celiaquía. Sello visible en el stand.",
  },
];

export function ProtocolV2() {
  return (
    <ThemedSection theme="papel" className="py-28 md:py-36 border-t border-line">
      <div className="container max-w-6xl">
        ...
        <p className="mt-6 max-w-2xl text-lg text-ink-muted text-pretty">
          ...
          con cada partner antes de que entre al festival.
        </p>

        <ul className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {SEALS.map(({ Icon, title, body }, i) => (
            <li key={title} className="card-elevated">
              <div className="flex items-start gap-4">
                <span className="shrink-0 grid place-items-center w-12 h-12 rounded-2xl bg-brand-orange/15 text-brand-orange">
        ...
        <div className="mt-12 flex flex-wrap gap-4">
          <Link href="/protocolo" className="btn-primary">
            Lee el protocolo completo
          </Link>
          <a href="/protocolo.pdf" className="btn-outline">
            Descargar PDF
          </a>
        </div>
      </div>
